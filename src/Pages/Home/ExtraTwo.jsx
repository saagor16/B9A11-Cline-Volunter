	...
	<div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
		<div className="flex flex-col items-center mx-12 lg:mx-0">
			<div className="relative text-center">
				...
				<p className="px-6 py-1 text-lg italic"> Our happy volunteer, Leroy Jenkins, embodies the spirit of generosity and goodwill. With a contagious enthusiasm, Leroy selflessly dedicates time and effort to our cause, spreading positivity wherever he goes.</p>
		...
		<div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
			<div className="relative text-center">
				...
				<p className="px-6 py-1 text-lg italic">Emily Johnson is the heart and soul of our volunteer community, radiating happiness and warmth with every task undertaken. With an infectious spirit and boundless energy, Emily approaches each opportunity to serve with genuine joy and enthusiasm. Whether its lending a helping hand at events or spearheading initiatives.</p>
